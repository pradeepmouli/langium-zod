...
describe('generateNamespaceOps', () => {
  ...
  it('emits setOutput only for required single-node field', () => {
    const result = generateNamespaceOps([rosettaFunctionRequired]);
  ...
  it('emits setOutput + clearOutput for optional single-node field', () => {
    const result = generateNamespaceOps([rosettaFunctionOptional]);
  ...
  it('produces balanced braces', () => {
    const result = generateNamespaceOps([dataType, rosettaFunctionRequired]);
