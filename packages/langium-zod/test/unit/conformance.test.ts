...
describe('conformance helpers', () => {
  ...
  it('resolves ast path from explicit or langium out directory', () => {
    expect(resolveAstTypesPath('/workspace', '/workspace/src/generated')).toBe(
      '/workspace/src/generated/ast.ts'
    );
    expect(resolveAstTypesPath('/workspace', '/workspace/src/generated', './custom/ast.ts')).toBe(
      '/workspace/custom/ast.ts'
    );
  });
